...
public class Utils {
    ...
    public static String text2bin(String s){
    ...
    public static String bin2text(String s){
    ...
    public static String text2hex(String message){
        return bin2hex(text2bin(message));
    }

    public static String hex2text(String message){
